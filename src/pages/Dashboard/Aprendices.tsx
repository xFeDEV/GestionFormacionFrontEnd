import Kpi from "../../components/aprendizGraph/Kpi";
import Modality from "../../components/aprendizGraph/Modality";
...
import Level from "../../components/aprendizGraph/Level";
import Day from "../../components/aprendizGraph/Day";
import Municipalities from "../../components/aprendizGraph/Municipalities";
    ...
    />
      <div className="grid grid-cols-12 gap-4 md:gap-6">
        ...
        <div className="col-span-12 xl:col-span-5">
          <Modality filters={filters} />
        </div>

        <div className="col-span-12 space-y-6 xl:col-span-7">
          <Municipalities filters={filters} />
        </div>
